...
def init_db() -> None:
    ...
    with get_db() as conn:
        ...
        ensure_column(conn, "licenses", "free_reset_hours", "INTEGER")
        ensure_column(conn, "licenses", "free_reset_data_gb", "INTEGER")
        ensure_column(conn, "licenses", "free_reset_days", "INTEGER")
        ensure_column(conn, "licenses", "free_next_reset_at", "TEXT")
        ensure_column(conn, "licenses", "free_last_reset_at", "TEXT")
